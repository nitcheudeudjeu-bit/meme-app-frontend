  ...
  return (
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text style={styles.subtitle}>Choisis une image · l'IA génère ton mème</Text>
        ...
        {!imageAsset && !loading && (
          <View style={styles.placeholder}>
            ...
            <Text style={styles.placeholderText}>Sélectionne une image pour commencer</Text>
          </View>
        )}
      </ScrollView>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  container: { flexGrow: 1, alignItems: 'center', paddingHorizontal: 20, paddingTop: 32, paddingBottom: 40 },
  ...
  retryBtn: { marginTop: 16, borderWidth: 2, borderColor: '#6D28D9', paddingVertical: 12, paddingHorizontal: 28, borderRadius: 12 },
